...
Description: A central registry for addons looking for something to attach their data to
...
if lib.libdatabroker_domt then
  lib.libdatabroker_domt.__index = nil
end

lib.libdatabroker_domt = {
...
function lib:NewDataObject(name, dataobj)
  ...
  dataobj = setmetatable(dataobj or {}, self.libdatabroker_domt)
